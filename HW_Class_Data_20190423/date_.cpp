...
string date_::DateInWords() const
{
	...
	string strM01 = " января";
	string strM02 = " февраля";
	string strM03 = " марта";
	string strM04 = " апреля";
	string strM05 = " мая";
	string strM06 = " июня";
	string strM07 = " июля";
	string strM08 = " августа";
	string strM09 = " сентября";
	string strM10 = " октября";
	string strM11 = " ноября";
	string strM12 = " декабря";
